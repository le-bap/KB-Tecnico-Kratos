...
<ul>
  <li><input type="checkbox"> <span>Verificar estado geral do robô e anotar/fotografar arranhões ou amassados</span></li>
  <li><input type="checkbox"> <span>Limpar estrutura do robô + bandejas</span></li>
  ...
  <li><input type="checkbox"> <span>Fechar chamado no Milvus</span></li>
</ul>

<button onclick="baixarPDF('Retorno')" style="
